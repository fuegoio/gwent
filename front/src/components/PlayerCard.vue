<template>
    <v-row no-gutters>
        ...
        <v-col class="fill-height">
            <v-card class="fill-height pa-3 stats" dark>
                ...
                <v-row align="center" class="mt-5" justify="center">
                    <v-col style="padding: 0" cols="3">
                        ...
                        <v-img v-else src="ruby-grey.png" class="ruby"></v-img>
                    </v-col>
                    <v-col cols="3"></v-col>
                    <v-col style="padding: 0" cols="3">
                        <v-img v-if="player['lives'] === 2" src="ruby.png" class="ruby"></v-img>
                        <v-img v-else-if="player['lives'] < 2" src="ruby-grey.png" class="ruby"></v-img>
                    </v-col>
                </v-row>
            </v-card>
        </v-col>
